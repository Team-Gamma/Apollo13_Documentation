...
\input{./3_Beschreibung_der_Bodenstation/bodenstation_doku_spezifische-beschreibungen}

\input{./3_Beschreibung_der_Bodenstation/bodenstation_doku_realisierung}

\begin{comment}

\subsection{App Übersicht}
...
\subsection{Plattform und Komponenten}
