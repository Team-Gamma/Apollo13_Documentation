...
\subsubsection{niedrige Gazen Belastung}
Beim Test der Fallschirmgröße ist uns aufgefallen, das die Gaze bei mehreren versuchen kleine Risse bekommen hat. Das Material, das wir verwendet haben ist nicht stark genug, um die Belastungen während des Fluges zu tragen. Aus diesen Grund haben wir uns, auch aus Zeitgründen, dazu entschieden die Gaze komplett weg zu lassen. Stattdessen verwenden wir, wie im letzten Jahr, acht Schnüre, die am Dosendecke befestigt werden.